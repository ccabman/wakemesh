...
All notable changes to WakeMesh are documented here.
...
- Add multi-source and multi-assistant Engine configuration.
- Add unique logical satellite identities.
- Add response capture and Home Assistant media-player routing.
